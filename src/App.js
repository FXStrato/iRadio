            ...
            <Paper zDepth={1}>
                <Toolbar style={{backgroundColor: '#262626',}}>
                  <ToolbarGroup onClick={this.goHome}>
                      <img style={{float: 'left', width: '50px', height: '50px', marginTop: '10px'}} src={mainIcon} alt="Network by Dmitry Mirolyubov from the Noun Project"/>
                      <div className="flow-text" style={{cursor: 'pointer'}}>iRadio</div>
                  </ToolbarGroup>
                  <ToolbarGroup>
                    <IconMenu
